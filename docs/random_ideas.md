...
- run can be me win in one run by hard core gamer, but it wouls be very difficult

- Limited time ? limit 2100 or no limited time, only global warmig limit 2°C
- Crisie mega fire: can ask for help to neighbours countries 
-  Répondre aux crises en dépensant des ressources/happiness/diplomacy (like Battle star galactica)
- Construire un moteur de production (money, happyniess, diplomacy)
    - au début l'industry rapport beaucoup d'argent mais emet beaucoup de CO2
- Emission par région (industry, transport, agro-alimentaire)
- Metric Biodiversité en plsu des emission carbon ?
- Absorption global (ocean, foret)
- Lancer les petits projets sur des villes (plat based food sur une ville, railroad/bikes road sur une ville)
- Ajouter une carte du monde
- Inspirations: Hades (rogue-lite addictif), Civilisation (city builder), Terra Nil (strategy nettoyage d'environment)
- Revoir l'équilibrage: trop peu d'argent au début
- 1 crise par tour
- Print current money + income par tour (pour chaque variable, diplomacy, absorption, emission, hapiness)
